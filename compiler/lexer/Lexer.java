...
public class Lexer {
    ...
    private int startPosition, endPosition, lineNum = 0;
    ...
    /*public static void main(String args[]) {
        ...
        try {
            ...
            // print sourcereader copy of program w/ line # and . -> 1.
        } catch (Exception e) {
        }
    }*/
    ...
    public Token newFloatToken(String fl, int startPosition, int endPosition) {
        return new Token(startPosition, endPosition, Symbol.symbol(fl, Tokens.FLOat));
    }
    ...
    public Token makeToken(String s, int startPosition, int endPosition) {
        ...
        if (sym == null) {
            System.out.println("\n*** Error illegal character: " + s + " in "+file+" (line "+source.getLineno()+")");
            System.out.println(source.getRam());
            atEOF = true;
            return nextToken();
        }
    ...
    public Token nextToken() { // ch is always the next char to process
        ...
        // get current start/end positions
        ...
        if(ch == '.') {
            ...
            try {
              do {
                ...
                if(fl.equals(".")) {
                  makeToken(fl, startPosition, endPosition);
                }
            } catch(Exception e) {
              atEOF = true;
            }
            return newFloatToken(fl, startPosition, endPosition);
        }
