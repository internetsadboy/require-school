 ...
 *    -> BLOCK
 *    -> NAME ‘=’ E                    ==> assign 
 *    -> 'repeat' BLOCK 'while' E      ==> repeat<br>
 *
 *  E -> SE
 *    -> SE ‘==’ SE   ==> =
 *    -> SE ‘!=’ SE   ==> !=
...
*/  
    ...
    // pass the sourceProgram to Lexer -> passes file to sourceReader
    // call scan (fetches nextToken)
 ...
 *  @exception SyntaxError - thrown for any syntax error
*/  
    // added FloatTypeTree class 
    // ASTVisitor.java  added public abstract Object visitFloatTypeTree(AST t); 
    // PrintVisitor.java added public Object visitFloatTypeTree(AST t) { print("FloatType",t);  return null; } 
 ...
 *        -> block
 *        -> name '=' e  ==> assign
 *        -> 'repeat' block 'while' e
 *  </pre>
 *  @return the tree corresponding to the statement found
 *  @exception SyntaxError - thrown for any syntax error
*/  
    // ASTVisitor.java public abstract Object visitRepeatTree(AST t);
    // 
    public AST rStatement() throws SyntaxError {
        ...
        // if currentToken = 'repeat'
        // continue scanning tokens
        // create instance of RepeatTree()
        // addkid block
        // expect 'while' token or throw err
        // addkid e
 ...
 *  @exception SyntaxError - thrown for any syntax error
*/
    // PrintVisitor.java public Object visitFloatTree(AST t) { print("Float: "+((FloatTree)t).getSymbol().toString(),t);  return null; }
    // ASTVisitor.java   public abstract Object visitFloatTree(AST t);
    // FloatTree.java    added FloatTree class
...
*/  
    // idTreeMakerThing
    // if next token is of kind identifier
    // create a new instance of the idtree
    // scan() to iterate to the next token
    // return the tree
    // else throw syntax err      
    ...
    // fetch kind of token we're dealing with
    // if relationOps contains kind -> create instance of RelOpTree
    //                              -> scan() iterates next token
    ...
    // return an addOpTree w/ currentToken
    // scan() -> iterate next token
    // return newly created tree
    // else return null
    ...
    // get kind of token
    // check if it exists within multOps enum struct
    // if it exists in the enum
    // create new instance of MultOpTree 
    // scan() -> iterate to next token
    // return newly created tree
    // else return null
    ...
    // used in expect 
    // verifies the the currentToken is the kind that we want
    // returns corresponding boolean logic
    ...
    // expects checks if the next token is of the expected 'kind' (a prop of Token)
    // if true -> continue to scan (fetch next token) and return
    ...
    // fetch next token
    // if the current token != null print that shit
    private void scan() {
